			...
			"
				...
				<div className="font-light text-neutral-500">
					...
					{dayAndNight({ startDate, endDate }) && (
						<p className="text-xs  text-neutral-500">{dayAndNight({ startDate, endDate })}</p>
					)}
				</div>
				...
				{onAction && actionLabel && (
					<Button disabled={disabled} loading={disabled} small label={actionLabel} onClick={handleCancel} />
				)}
			</div>
		</div>
	);
